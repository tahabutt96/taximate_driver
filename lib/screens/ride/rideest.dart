...
import 'package:taximate_driver/screens/ride/ridecom.dart';
...
class Rideest extends StatefulWidget {
  const Rideest({Key? key}) : super(key: key);

  @override
  _RideestState createState() => _RideestState();
}

class _RideestState extends State<Rideest> {
