...
class Payone extends StatefulWidget {
  const Payone({Key? key}) : super(key: key);

  @override
  _PayoneState createState() => _PayoneState();
}

class _PayoneState extends State<Payone> {
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Image(image: AssetImage("assets/images/payone.png"))
                      ],
                    ),
                  ),
                ),
